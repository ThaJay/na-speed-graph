...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactChartjs = __webpack_require__(158);
	...
	var SpeedChart = function (_Component) {
	  _inherits(SpeedChart, _Component);

	  function SpeedChart() {
	    _classCallCheck(this, SpeedChart);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SpeedChart).apply(this, arguments));
	  }

	  _createClass(SpeedChart, [{
	    key: 'render',
	    value: function render() {
	      var options = {},
	          angles = [0, 45, 90, 135, 180, 225, 270, 315],
	          cutterPerf = [-2, 17, 20, 18, 15, 18, 20, 17],
	          getCutterVMG = function getCutterVMG() {
	        return angles.map(function (angle, i) {
	          return Math.abs(getVelocityMadeGood(angle, cutterPerf[i]));
	        });
	      },
	          getVelocityMadeGood = function getVelocityMadeGood(degrees, speed) {
	      ...
	      return _react2.default.createElement(_reactChartjs.Radar, {
	        data: data,
	        options: options,
	        width: '600',
	        height: '600'
	...
	(0, _reactDom.render)(_react2.default.createElement(SpeedChart, null), document.getElementsByClassName('root')[0]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  Bar: __webpack_require__(159),
	  Doughnut: __webpack_require__(164),
	  Line: __webpack_require__(165),
	  Pie: __webpack_require__(166),
	  PolarArea: __webpack_require__(167),
	  Radar: __webpack_require__(168),
	  createClass: __webpack_require__(160).createClass
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vars = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
		...
		var each = helpers.each = function(loopable,callback,self){
			...
			amd = helpers.amd = ("function" == 'function' && __webpack_require__(163)),
			//-- Math methods
